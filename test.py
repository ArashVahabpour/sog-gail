...
from eval import plot_env, play_env, benchmark_env, robustness_test
...
for epoch in ['pretrain']: #['pretrain'] + list(range(0, int(args.num_env_steps) // args.num_steps, args.save_interval)):
    ...
    test_task = {'benchmark': benchmark_env, 'plot': plot_env, 'play': play_env, 'robustness_test': robustness_test}.get(args.test_task, None)
