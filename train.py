...
def main():
    ...
    for j in tqdm(range(num_updates)):
        ...
        for step in range(args.num_steps):
            latent_code = utils.generate_latent_codes(args)
            # Sample actions
            with torch.no_grad():
                value, latent_code, action, action_log_prob = actor_critic.act(rollouts.obs[step], latent_code)
